    ...
    return (
        <>
            <form className='d-flex flex-column container' onSubmit={handleFinalizeOrder}>
                ...
                <label className='fs-6 labelCheck' htmlFor={idCheckTakeAway}>
                ...
                <label className='fs-6 labelCheck' htmlFor={idCheckDelivery}>
                ...
                <article className='d-flex flex-column pt-2'>
                  ...
                  <label className='fs-6 labelCheck' htmlFor={idCheckboxCash}>
                    <input type='radio' id={idCheckboxCash} name='paymentMethod' value='Efectivo' required /> <span>Efectivo</span>
                    <span className='checkmark' />
                  </label>

                  <label className='fs-6 labelCheck' htmlFor={idCheckboxMP}>
                ...
                <article className='d-flex flex-column align-items-center pt-5 mb-3'>
                  <div className='d-flex justify-content-between align-items-center pb-1 maxWidth'>
                    <span className='fs-5 fw-semibold'>Total:</span>
                    <span className='fs-5 fw-semibold'>${subTotal(state)}</span>
                  </div>
                  <button className='fs-6 btn btn-dark rounded fw-semibold text-uppercase maxWidth' type='submit'>Confirmar Pedido</button>
                </article>
              </form>
        </>
    )
